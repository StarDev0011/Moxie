...
(function ($) {
  ...
  $(function () {
    ...
    $("body").on("submit", ".ajaxcart", function () {
      $(".cart__checkout.shouldLoad").addClass("btn--loading");
    });
  ...
  theme.CartDrawer = (function () {
    ...
    CartDrawer.prototype = $.extend({}, CartDrawer.prototype, {
        ...
        if (cart.item_count === 0) {
          ...
          $.each(cart.items, function (index, product) {
            ...
            item = {
              ...
              discountsApplied:
                product.price === product.price - product.total_discount
                  ? false
                  : true,
      ...
      removeItem: function (key) {
        // console.log('ajaxifyCartremove',key);
        if (this.status.loading) {
          return;
        }

        let k = $(key.currentTarget).data("key");
  ...
  theme.AjaxProduct = (function () {
    ...
    function ProductForm($form) {
      ...
      this.addItemFromForm = function (evt, callback) {7
        evt.preventDefault();
  ...
  theme.AjaxProductAdToCart=function(selector){
  ...
  theme.RecentlyViewed = (function () {
    ...
    function RecentlyViewed(container) {
      ...
      $(window).on(
        ...
        $.throttle(200, this.checkVisibility.bind(this))
      );
    }
    ...
    RecentlyViewed.prototype = $.extend({}, RecentlyViewed.prototype, {
      ...
      setupOutput: function (products) {
        ...
        for (key in products) {
          ...
          product.url_formatted = theme.recentlyViewed.recent[product.handle]
          ...
          product.compare_at_price_formatted = theme.Currency.formatMoney(
  ...
  theme.Product = (function () {
    ...
    function Product(container) {
      ...
      this.productObject = JSON.parse(
        document.getElementById(this.selectors.productJson).innerHTML
      );
    ...
    Product.prototype = $.extend({}, Product.prototype, {
      ...
      addIdToRecentlyViewed: function () {
        ...
        $.cookie("theme-recent", JSON.stringify(theme.recentlyViewed.recent), {
          path: "/",
          expires: 10000
        });
      },
      ...
      updateVariantImage: function (evt) {
        ...
        var imageIndex = this._slideIndex(
      ...
      createImageCarousels: function () {
        ...
        if (this.settings.zoom) {
          this.initZoom(
            $(this.selectors.productImageMain).find(selectors.zoomImage)
          );
        }
      ...
      setSliderArgs: function () {
        ...
        var thumbnailsVertical =
          this.$thumbSlider.data("position") === "beside" ? true : false;
      ...
      resizeSlides: function () {
        ...
        setTimeout(
          ...
          500
        ); // same timing as modal open transition
      },
  ...
  theme.Collection = (function () {
    ...
    Collection.prototype = $.extend({}, Collection.prototype, {
      init: function () {
        ...
        var sectionId = (this.sectionId = this.$container.attr(
          "data-section-id"
        ));
  ...
  theme.Testimonials = (function () {
    ...
    Testimonials.prototype = $.extend({}, Testimonials.prototype, {
      ...
      onBlockSelect: function (evt) {
        // Ignore the cloned version
        var $slide = $(
          ".testimonials-slide--" + evt.detail.blockId + ":not(.slick-cloned)"
        );
        var slideIndex = $slide.data("slick-index");
  ...
  theme.Instagram = (function () {
    function Instagram(container) {
      ...
      var gridItemWidth = $target.data("grid-item-width");
      ...
      var feed = (this.feed = new Instafeed({
        ...
        template:
          ...
          gridItemWidth +
          '"><div class="image-wrap"><a href="{{link}}" target="_blank" style="background-image: url({{image}}); display: block; padding-bottom: 100%; background-size: cover; background-position: center;"></a></div></div>',
    ...
    NewsletterPopup.prototype = $.extend({}, NewsletterPopup.prototype, {
      ...
      closePopup: function () {
        ...
        $.cookie(this.cookieName, "opened", {
          path: "/",
          expires: this.data.daysBeforeReappear
        });
      },
  ...
  theme.FadingImages = (function () {
    ...
    FadingImages.prototype = $.extend({}, FadingImages.prototype, {
      ...
      nextImage: function () {
        ...
        window.setTimeout(function () {
          $container
            .find(".fading-images__item[data-slide-index=" + target_image + "]")
      ...
      nextTitle: function () {
        ...
        window.setTimeout(function () {
          var newText1 = $container
            .find(".fading-images__item[data-slide-index=" + target_title + "]")
  ...
  theme.setGlobals = function () {
    ...
    if (theme.recentlyViewed.handleCookie) {
      theme.recentlyViewed.recent = JSON.parse(
        theme.recentlyViewed.handleCookie
      );
    }
  ...
  $(document).ready(function () {
    ...
    theme.AjaxProductAdToCart('.product-single__form'); 
  });
})(theme.jQuery);
...
jQuery(document).on('click','.ajax_add_to_cart',function(e){
  ...
  let context = $(this);
  let btnText= context.text();
        e.preventDefault(); 
  $(this).text('').addClass('btn--loading');
 let cvaraint = $(this).data('pid');
        CartJS.addItem(cvaraint, 1, {}, {
            "success": function (data, textStatus, jqXHR) {
  
                context.text('Added').removeClass('btn--loading');
                setTimeout(function(){
                  context.text(btnText).removeClass('btn--loading');
                },1000);
            },  
